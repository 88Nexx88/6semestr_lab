...
public class Tools {
    ...
    public void generatedRandomByte() throws IOException {
        int N = 10000;
        byte[] array = new byte[N];
        for(int i = 0; i < N; i++){
            array[i] = (byte)StdRandom.uniform(0, 256);
        }
        //byte[] qwe = {(byte) 255, (byte) 0, (byte) 255, (byte) 0, (byte) 255, (byte) 0, (byte) 255, (byte) 0};
        writeToFile("generatedFile", array);
    }
